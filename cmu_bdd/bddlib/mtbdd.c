...
void
#if defined(__STDC__)
mtbdd_transform_closure(bdd_manager bddm,
...
void
#if defined(__STDC__)
mtbdd_one_data(bdd_manager bddm, INT_PTR value1, INT_PTR value2)
#else
...
void
#if defined(__STDC__)
mtbdd_free_terminal_closure(bdd_manager bddm,
...
bdd
#if defined(__STDC__)
mtbdd_get_terminal(bdd_manager bddm, INT_PTR value1, INT_PTR value2)
#else
...
void
#if defined(__STDC__)
mtbdd_terminal_value(bdd_manager bddm, bdd f, INT_PTR *value1, INT_PTR *value2)
#else
...
bdd
#if defined(__STDC__)
mtbdd_ite(bdd_manager bddm, bdd f, bdd g, bdd h)
#else
...
bdd
#if defined(__STDC__)
mtbdd_substitute(bdd_manager bddm, bdd f)
#else
...
bdd
#if defined(__STDC__)
mtbdd_equal(bdd_manager bddm, bdd f, bdd g)
#else
